...
if (isset ($_POST["handle"]) && isset ($_POST["password"]))
{
	...
	{
		Session::exit_with_error("Invalid Password", "Password must consist of between 6 and 31 (inclusive) characters containing at least one non-alphanumeric character.");
	}
